...
int PathFinder::getRows() const { return grid.getRows(); }

int PathFinder::getColumns() const { return grid.getColumns(); }
...
void PathFinder::transferStartEnd(const PathFinder &other) {
  start = other.start;
  end = other.end;
}